...
type V1DevicesUpgradeSchedulePutRequest struct {
	...
	DeviceVersions []V1DevicesUpgradeSchedulePutRequestDeviceVersion `json:"deviceVersions,omitempty"`
...
func (o *V1DevicesUpgradeSchedulePutRequest) GetDeviceVersions() []V1DevicesUpgradeSchedulePutRequestDeviceVersion {
	if o == nil || IsNil(o.DeviceVersions) {
		var ret []V1DevicesUpgradeSchedulePutRequestDeviceVersion
		return ret
	}
...
// SetDeviceVersions gets a reference to the given []V1DevicesUpgradeSchedulePutRequestDeviceVersion and assigns it to the DeviceVersions field.
