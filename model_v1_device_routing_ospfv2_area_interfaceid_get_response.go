...
// checks if the V1DeviceRoutingOspfv2AreaInterfaceidGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1DeviceRoutingOspfv2AreaInterfaceidGetResponse{}

// V1DeviceRoutingOspfv2AreaInterfaceidGetResponse struct for V1DeviceRoutingOspfv2AreaInterfaceidGetResponse
type V1DeviceRoutingOspfv2AreaInterfaceidGetResponse struct {
...
func NewV1DeviceRoutingOspfv2AreaInterfaceidGetResponse() *V1DeviceRoutingOspfv2AreaInterfaceidGetResponse {
	this := V1DeviceRoutingOspfv2AreaInterfaceidGetResponse{}
	return &this
}
...
func (o V1DeviceRoutingOspfv2AreaInterfaceidGetResponse) MarshalJSON() ([]byte, error) {
...
func (o V1DeviceRoutingOspfv2AreaInterfaceidGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableV1DeviceRoutingOspfv2AreaInterfaceidGetResponse struct {
	value *V1DeviceRoutingOspfv2AreaInterfaceidGetResponse
	isSet bool
}

func (v NullableV1DeviceRoutingOspfv2AreaInterfaceidGetResponse) Get() *V1DeviceRoutingOspfv2AreaInterfaceidGetResponse {
	return v.value
}

func (v *NullableV1DeviceRoutingOspfv2AreaInterfaceidGetResponse) Set(val *V1DeviceRoutingOspfv2AreaInterfaceidGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableV1DeviceRoutingOspfv2AreaInterfaceidGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableV1DeviceRoutingOspfv2AreaInterfaceidGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1DeviceRoutingOspfv2AreaInterfaceidGetResponse(val *V1DeviceRoutingOspfv2AreaInterfaceidGetResponse) *NullableV1DeviceRoutingOspfv2AreaInterfaceidGetResponse {
	return &NullableV1DeviceRoutingOspfv2AreaInterfaceidGetResponse{value: val, isSet: true}
}

func (v NullableV1DeviceRoutingOspfv2AreaInterfaceidGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1DeviceRoutingOspfv2AreaInterfaceidGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
