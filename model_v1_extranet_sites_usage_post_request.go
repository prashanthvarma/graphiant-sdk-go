...
// checks if the V1ExtranetSitesUsagePostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1ExtranetSitesUsagePostRequest{}

// V1ExtranetSitesUsagePostRequest struct for V1ExtranetSitesUsagePostRequest
type V1ExtranetSitesUsagePostRequest struct {
...
type _V1ExtranetSitesUsagePostRequest V1ExtranetSitesUsagePostRequest
...
func NewV1ExtranetSitesUsagePostRequest(id int64, isB2B bool, isProvider bool, timeWindow StatsmonTimeWindow) *V1ExtranetSitesUsagePostRequest {
	this := V1ExtranetSitesUsagePostRequest{}
	this.Id = id
	this.IsB2B = isB2B
...
func (o V1ExtranetSitesUsagePostRequest) MarshalJSON() ([]byte, error) {
...
func (o V1ExtranetSitesUsagePostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *V1ExtranetSitesUsagePostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varV1ExtranetSitesUsagePostRequest := _V1ExtranetSitesUsagePostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV1ExtranetSitesUsagePostRequest)

	if err != nil {
		return err
	}

	*o = V1ExtranetSitesUsagePostRequest(varV1ExtranetSitesUsagePostRequest)

	return err
}

type NullableV1ExtranetSitesUsagePostRequest struct {
	value *V1ExtranetSitesUsagePostRequest
	isSet bool
}

func (v NullableV1ExtranetSitesUsagePostRequest) Get() *V1ExtranetSitesUsagePostRequest {
	return v.value
}

func (v *NullableV1ExtranetSitesUsagePostRequest) Set(val *V1ExtranetSitesUsagePostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableV1ExtranetSitesUsagePostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableV1ExtranetSitesUsagePostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1ExtranetSitesUsagePostRequest(val *V1ExtranetSitesUsagePostRequest) *NullableV1ExtranetSitesUsagePostRequest {
	return &NullableV1ExtranetSitesUsagePostRequest{value: val, isSet: true}
}

func (v NullableV1ExtranetSitesUsagePostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1ExtranetSitesUsagePostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
