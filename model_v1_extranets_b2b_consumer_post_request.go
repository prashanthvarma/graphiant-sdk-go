...
type V1ExtranetsB2bConsumerPostRequest struct {
	Policy []ManaV2ExtranetConsumerLanSegmentPolicy `json:"policy,omitempty"`
...
func (o *V1ExtranetsB2bConsumerPostRequest) GetPolicy() []ManaV2ExtranetConsumerLanSegmentPolicy {
	if o == nil || IsNil(o.Policy) {
		var ret []ManaV2ExtranetConsumerLanSegmentPolicy
		return ret
	}
	return o.Policy
}
...
// SetPolicy gets a reference to the given []ManaV2ExtranetConsumerLanSegmentPolicy and assigns it to the Policy field.
