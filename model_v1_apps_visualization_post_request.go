...
type V1AppsVisualizationPostRequest struct {
	// Circuit name is specified if circuit apps utilization data is desired.
	CircuitName *string `json:"circuitName,omitempty"`
	DeviceId *int64 `json:"deviceId,omitempty"`
	IsDia *bool `json:"isDia,omitempty"`
	// SLA class is specified if queue apps utilization data is desired. Circuit name must be provided.
