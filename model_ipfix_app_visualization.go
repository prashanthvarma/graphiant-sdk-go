...
// checks if the IpfixAppVisualization type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpfixAppVisualization{}

// IpfixAppVisualization struct for IpfixAppVisualization
type IpfixAppVisualization struct {
	AppId *int32 `json:"appId,omitempty"`
	AppName *string `json:"appName,omitempty"`
	CircuitAvailability *map[string]int32 `json:"circuitAvailability,omitempty"`
	CircuitMap *map[string]IpfixCircuitMetrics `json:"circuitMap,omitempty"`
...
func (o *IpfixAppVisualization) GetCircuitMap() map[string]IpfixCircuitMetrics {
	if o == nil || IsNil(o.CircuitMap) {
		var ret map[string]IpfixCircuitMetrics
		return ret
	}
	return *o.CircuitMap
}
...
// SetCircuitMap gets a reference to the given map[string]IpfixCircuitMetrics and assigns it to the CircuitMap field.
...
func (o IpfixAppVisualization) MarshalJSON() ([]byte, error) {
...
func (o IpfixAppVisualization) ToMap() (map[string]interface{}, error) {
...
type NullableIpfixAppVisualization struct {
	value *IpfixAppVisualization
	isSet bool
}

func (v NullableIpfixAppVisualization) Get() *IpfixAppVisualization {
	return v.value
}

func (v *NullableIpfixAppVisualization) Set(val *IpfixAppVisualization) {
	v.value = val
	v.isSet = true
}

func (v NullableIpfixAppVisualization) IsSet() bool {
	return v.isSet
}

func (v *NullableIpfixAppVisualization) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpfixAppVisualization(val *IpfixAppVisualization) *NullableIpfixAppVisualization {
	return &NullableIpfixAppVisualization{value: val, isSet: true}
}

func (v NullableIpfixAppVisualization) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpfixAppVisualization) UnmarshalJSON(src []byte) error {
	v.isSet = true
