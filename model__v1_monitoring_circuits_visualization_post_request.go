...
type V1MonitoringCircuitsVisualizationPostRequest struct {
	...
	Selectors []V1MonitoringCircuitsVisualizationPostRequestSelectorsInner `json:"selectors,omitempty"`
...
// SetSelectors gets a reference to the given []V1MonitoringCircuitsVisualizationPostRequestSelectorsInner and assigns it to the Selectors field.
