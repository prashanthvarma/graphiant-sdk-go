...
**Selectors** | Pointer to [**[]StatsmonV2IpSecStatsSelector**](StatsmonV2IpSecStatsSelector.md) |  | [optional] 
...
`func (o *V2MonitoringIpsecPostRequest) GetSelectors() []StatsmonV2IpSecStatsSelector`

GetSelectors returns the Selectors field if non-nil, zero value otherwise.

### GetSelectorsOk

`func (o *V2MonitoringIpsecPostRequest) GetSelectorsOk() (*[]StatsmonV2IpSecStatsSelector, bool)`
...
`func (o *V2MonitoringIpsecPostRequest) SetSelectors(v []StatsmonV2IpSecStatsSelector)`
...
`func (o *V2MonitoringIpsecPostRequest) GetTimeWindow() StatsmonV2TimeWindow`

GetTimeWindow returns the TimeWindow field if non-nil, zero value otherwise.

### GetTimeWindowOk

`func (o *V2MonitoringIpsecPostRequest) GetTimeWindowOk() (*StatsmonV2TimeWindow, bool)`
...
`func (o *V2MonitoringIpsecPostRequest) SetTimeWindow(v StatsmonV2TimeWindow)`
