...
### NewManaV2IPsecTunnel

`func NewManaV2IPsecTunnel() *ManaV2IPsecTunnel`

NewManaV2IPsecTunnel instantiates a new ManaV2IPsecTunnel object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewManaV2IPsecTunnelWithDefaults

`func NewManaV2IPsecTunnelWithDefaults() *ManaV2IPsecTunnel`

NewManaV2IPsecTunnelWithDefaults instantiates a new ManaV2IPsecTunnel object
This constructor will only assign default values to properties that have it defined,
but it doesn't guarantee that properties required by API are set

### GetDestinationAddress

`func (o *ManaV2IPsecTunnel) GetDestinationAddress() string`

GetDestinationAddress returns the DestinationAddress field if non-nil, zero value otherwise.

### GetDestinationAddressOk

`func (o *ManaV2IPsecTunnel) GetDestinationAddressOk() (*string, bool)`
...
`func (o *ManaV2IPsecTunnel) SetDestinationAddress(v string)`

SetDestinationAddress sets DestinationAddress field to given value.

### HasDestinationAddress

`func (o *ManaV2IPsecTunnel) HasDestinationAddress() bool`

HasDestinationAddress returns a boolean if a field has been set.

### GetIkeInitiator

`func (o *ManaV2IPsecTunnel) GetIkeInitiator() bool`

GetIkeInitiator returns the IkeInitiator field if non-nil, zero value otherwise.

### GetIkeInitiatorOk

`func (o *ManaV2IPsecTunnel) GetIkeInitiatorOk() (*bool, bool)`
...
`func (o *ManaV2IPsecTunnel) SetIkeInitiator(v bool)`

SetIkeInitiator sets IkeInitiator field to given value.

### HasIkeInitiator

`func (o *ManaV2IPsecTunnel) HasIkeInitiator() bool`

HasIkeInitiator returns a boolean if a field has been set.

### GetIpsecLabel

`func (o *ManaV2IPsecTunnel) GetIpsecLabel() string`

GetIpsecLabel returns the IpsecLabel field if non-nil, zero value otherwise.

### GetIpsecLabelOk

`func (o *ManaV2IPsecTunnel) GetIpsecLabelOk() (*string, bool)`
...
`func (o *ManaV2IPsecTunnel) SetIpsecLabel(v string)`

SetIpsecLabel sets IpsecLabel field to given value.

### HasIpsecLabel

`func (o *ManaV2IPsecTunnel) HasIpsecLabel() bool`

HasIpsecLabel returns a boolean if a field has been set.

### GetLan

`func (o *ManaV2IPsecTunnel) GetLan() string`

GetLan returns the Lan field if non-nil, zero value otherwise.

### GetLanOk

`func (o *ManaV2IPsecTunnel) GetLanOk() (*string, bool)`
...
`func (o *ManaV2IPsecTunnel) SetLan(v string)`

SetLan sets Lan field to given value.

### HasLan

`func (o *ManaV2IPsecTunnel) HasLan() bool`

HasLan returns a boolean if a field has been set.

### GetLocalAddressV4

`func (o *ManaV2IPsecTunnel) GetLocalAddressV4() string`

GetLocalAddressV4 returns the LocalAddressV4 field if non-nil, zero value otherwise.

### GetLocalAddressV4Ok

`func (o *ManaV2IPsecTunnel) GetLocalAddressV4Ok() (*string, bool)`
...
`func (o *ManaV2IPsecTunnel) SetLocalAddressV4(v string)`

SetLocalAddressV4 sets LocalAddressV4 field to given value.

### HasLocalAddressV4

`func (o *ManaV2IPsecTunnel) HasLocalAddressV4() bool`

HasLocalAddressV4 returns a boolean if a field has been set.

### GetLocalAddressV6

`func (o *ManaV2IPsecTunnel) GetLocalAddressV6() string`

GetLocalAddressV6 returns the LocalAddressV6 field if non-nil, zero value otherwise.

### GetLocalAddressV6Ok

`func (o *ManaV2IPsecTunnel) GetLocalAddressV6Ok() (*string, bool)`
...
`func (o *ManaV2IPsecTunnel) SetLocalAddressV6(v string)`

SetLocalAddressV6 sets LocalAddressV6 field to given value.

### HasLocalAddressV6

`func (o *ManaV2IPsecTunnel) HasLocalAddressV6() bool`

HasLocalAddressV6 returns a boolean if a field has been set.

### GetLocalCircuit

`func (o *ManaV2IPsecTunnel) GetLocalCircuit() string`

GetLocalCircuit returns the LocalCircuit field if non-nil, zero value otherwise.

### GetLocalCircuitOk

`func (o *ManaV2IPsecTunnel) GetLocalCircuitOk() (*string, bool)`
...
`func (o *ManaV2IPsecTunnel) SetLocalIkePeerIdentity(v string)`

SetLocalIkePeerIdentity sets LocalIkePeerIdentity field to given value.

### HasLocalIkePeerIdentity

`func (o *ManaV2IPsecTunnel) HasLocalIkePeerIdentity() bool`

HasLocalIkePeerIdentity returns a boolean if a field has been set.

### GetMtu

`func (o *ManaV2IPsecTunnel) GetMtu() int32`

GetMtu returns the Mtu field if non-nil, zero value otherwise.

### GetMtuOk

`func (o *ManaV2IPsecTunnel) GetMtuOk() (*int32, bool)`
...
`func (o *ManaV2IPsecTunnel) SetMtu(v int32)`

SetMtu sets Mtu field to given value.

### HasMtu

`func (o *ManaV2IPsecTunnel) HasMtu() bool`

HasMtu returns a boolean if a field has been set.

### GetName

`func (o *ManaV2IPsecTunnel) GetName() string`

GetName returns the Name field if non-nil, zero value otherwise.

### GetNameOk

`func (o *ManaV2IPsecTunnel) GetNameOk() (*string, bool)`
...
`func (o *ManaV2IPsecTunnel) SetName(v string)`

SetName sets Name field to given value.

### HasName

`func (o *ManaV2IPsecTunnel) HasName() bool`

HasName returns a boolean if a field has been set.

### GetPresharedKey

`func (o *ManaV2IPsecTunnel) GetPresharedKey() string`

GetPresharedKey returns the PresharedKey field if non-nil, zero value otherwise.

### GetPresharedKeyOk

`func (o *ManaV2IPsecTunnel) GetPresharedKeyOk() (*string, bool)`
...
`func (o *ManaV2IPsecTunnel) SetPresharedKey(v string)`

SetPresharedKey sets PresharedKey field to given value.

### HasPresharedKey

`func (o *ManaV2IPsecTunnel) HasPresharedKey() bool`

HasPresharedKey returns a boolean if a field has been set.

### GetRemoteAddressV4

`func (o *ManaV2IPsecTunnel) GetRemoteAddressV4() string`

GetRemoteAddressV4 returns the RemoteAddressV4 field if non-nil, zero value otherwise.

### GetRemoteAddressV4Ok

`func (o *ManaV2IPsecTunnel) GetRemoteAddressV4Ok() (*string, bool)`
...
`func (o *ManaV2IPsecTunnel) SetRemoteAddressV6(v string)`

SetRemoteAddressV6 sets RemoteAddressV6 field to given value.

### HasRemoteAddressV6

`func (o *ManaV2IPsecTunnel) HasRemoteAddressV6() bool`

HasRemoteAddressV6 returns a boolean if a field has been set.

### GetRemoteIkePeerIdentity

`func (o *ManaV2IPsecTunnel) GetRemoteIkePeerIdentity() string`
...
`func (o *ManaV2IPsecTunnel) GetRemoteIkePeerIdentityOk() (*string, bool)`
...
`func (o *ManaV2IPsecTunnel) SetRemoteIkePeerIdentity(v string)`

SetRemoteIkePeerIdentity sets RemoteIkePeerIdentity field to given value.

### HasRemoteIkePeerIdentity

`func (o *ManaV2IPsecTunnel) HasRemoteIkePeerIdentity() bool`

HasRemoteIkePeerIdentity returns a boolean if a field has been set.

### GetRouting

`func (o *ManaV2IPsecTunnel) GetRouting() ManaV2IpsecRoutingConfig`

GetRouting returns the Routing field if non-nil, zero value otherwise.

### GetRoutingOk

`func (o *ManaV2IPsecTunnel) GetRoutingOk() (*ManaV2IpsecRoutingConfig, bool)`
...
`func (o *ManaV2IPsecTunnel) SetRouting(v ManaV2IpsecRoutingConfig)`

SetRouting sets Routing field to given value.

### HasRouting

`func (o *ManaV2IPsecTunnel) HasRouting() bool`

HasRouting returns a boolean if a field has been set.

### GetTcpMss

`func (o *ManaV2IPsecTunnel) GetTcpMss() int32`

GetTcpMss returns the TcpMss field if non-nil, zero value otherwise.

### GetTcpMssOk

`func (o *ManaV2IPsecTunnel) GetTcpMssOk() (*int32, bool)`
...
`func (o *ManaV2IPsecTunnel) SetTcpMss(v int32)`

SetTcpMss sets TcpMss field to given value.

### HasTcpMss

`func (o *ManaV2IPsecTunnel) HasTcpMss() bool`

HasTcpMss returns a boolean if a field has been set.

### GetVpnProfile

`func (o *ManaV2IPsecTunnel) GetVpnProfile() string`

GetVpnProfile returns the VpnProfile field if non-nil, zero value otherwise.

### GetVpnProfileOk

`func (o *ManaV2IPsecTunnel) GetVpnProfileOk() (*string, bool)`
...
`func (o *ManaV2IPsecTunnel) SetVpnProfile(v string)`

SetVpnProfile sets VpnProfile field to given value.

### HasVpnProfile

`func (o *ManaV2IPsecTunnel) HasVpnProfile() bool`
