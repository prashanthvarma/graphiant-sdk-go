...
`func (o *V2AssuranceBucketAppsPostRequest) GetExchangeServiceId() int64`

GetExchangeServiceId returns the ExchangeServiceId field if non-nil, zero value otherwise.

### GetExchangeServiceIdOk

`func (o *V2AssuranceBucketAppsPostRequest) GetExchangeServiceIdOk() (*int64, bool)`
...
`func (o *V2AssuranceBucketAppsPostRequest) SetExchangeServiceId(v int64)`

SetExchangeServiceId sets ExchangeServiceId field to given value.

### HasExchangeServiceId

`func (o *V2AssuranceBucketAppsPostRequest) HasExchangeServiceId() bool`
...
`func (o *V2AssuranceBucketAppsPostRequest) GetTimeWindow() AssuranceTimeWindow`

GetTimeWindow returns the TimeWindow field if non-nil, zero value otherwise.

### GetTimeWindowOk

`func (o *V2AssuranceBucketAppsPostRequest) GetTimeWindowOk() (*AssuranceTimeWindow, bool)`
...
`func (o *V2AssuranceBucketAppsPostRequest) SetTimeWindow(v AssuranceTimeWindow)`
