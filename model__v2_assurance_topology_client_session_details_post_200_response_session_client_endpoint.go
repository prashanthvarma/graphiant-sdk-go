...
// checks if the V2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint{}

// V2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint struct for V2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint
type V2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint struct {
...
func NewV2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint() *V2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint {
	this := V2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint{}
	return &this
}
...
func (o V2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint) MarshalJSON() ([]byte, error) {
...
func (o V2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint) ToMap() (map[string]interface{}, error) {
...
type NullableV2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint struct {
	value *V2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint
	isSet bool
}

func (v NullableV2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint) Get() *V2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint {
	return v.value
}

func (v *NullableV2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint) Set(val *V2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint) {
	v.value = val
	v.isSet = true
}

func (v NullableV2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint) IsSet() bool {
	return v.isSet
}

func (v *NullableV2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint(val *V2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint) *NullableV2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint {
	return &NullableV2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint{value: val, isSet: true}
}

func (v NullableV2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint) UnmarshalJSON(src []byte) error {
	v.isSet = true
