...
type _V2ExtranetSitesConsumptionOverviewPostRequest V2ExtranetSitesConsumptionOverviewPostRequest
...
func (o *V2ExtranetSitesConsumptionOverviewPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varV2ExtranetSitesConsumptionOverviewPostRequest := _V2ExtranetSitesConsumptionOverviewPostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV2ExtranetSitesConsumptionOverviewPostRequest)

	if err != nil {
		return err
	}

	*o = V2ExtranetSitesConsumptionOverviewPostRequest(varV2ExtranetSitesConsumptionOverviewPostRequest)
