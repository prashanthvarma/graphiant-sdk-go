...
// checks if the V1ExtranetsB2bIdCustomerPostRequestInvitesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1ExtranetsB2bIdCustomerPostRequestInvitesInner{}

// V1ExtranetsB2bIdCustomerPostRequestInvitesInner struct for V1ExtranetsB2bIdCustomerPostRequestInvitesInner
type V1ExtranetsB2bIdCustomerPostRequestInvitesInner struct {
...
func NewV1ExtranetsB2bIdCustomerPostRequestInvitesInner() *V1ExtranetsB2bIdCustomerPostRequestInvitesInner {
	this := V1ExtranetsB2bIdCustomerPostRequestInvitesInner{}
	return &this
}
...
func (o *V1ExtranetsB2bIdCustomerPostRequestInvitesInner) SetAdminEmail(v string) {
	o.AdminEmail = &v
}
...
func (o *V1ExtranetsB2bIdCustomerPostRequestInvitesInner) HasConsumerBwSite() bool {
	if o != nil && !IsNil(o.ConsumerBwSite) {
		return true
	}
...
func (o *V1ExtranetsB2bIdCustomerPostRequestInvitesInner) GetServicePrefixes() []string {
...
func (o V1ExtranetsB2bIdCustomerPostRequestInvitesInner) MarshalJSON() ([]byte, error) {
...
func (o V1ExtranetsB2bIdCustomerPostRequestInvitesInner) ToMap() (map[string]interface{}, error) {
...
type NullableV1ExtranetsB2bIdCustomerPostRequestInvitesInner struct {
	value *V1ExtranetsB2bIdCustomerPostRequestInvitesInner
	isSet bool
}

func (v NullableV1ExtranetsB2bIdCustomerPostRequestInvitesInner) Get() *V1ExtranetsB2bIdCustomerPostRequestInvitesInner {
	return v.value
}

func (v *NullableV1ExtranetsB2bIdCustomerPostRequestInvitesInner) Set(val *V1ExtranetsB2bIdCustomerPostRequestInvitesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableV1ExtranetsB2bIdCustomerPostRequestInvitesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableV1ExtranetsB2bIdCustomerPostRequestInvitesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1ExtranetsB2bIdCustomerPostRequestInvitesInner(val *V1ExtranetsB2bIdCustomerPostRequestInvitesInner) *NullableV1ExtranetsB2bIdCustomerPostRequestInvitesInner {
	return &NullableV1ExtranetsB2bIdCustomerPostRequestInvitesInner{value: val, isSet: true}
}

func (v NullableV1ExtranetsB2bIdCustomerPostRequestInvitesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1ExtranetsB2bIdCustomerPostRequestInvitesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
