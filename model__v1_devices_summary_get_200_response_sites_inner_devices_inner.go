...
// checks if the V1DevicesSummaryGet200ResponseSitesInnerDevicesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1DevicesSummaryGet200ResponseSitesInnerDevicesInner{}

// V1DevicesSummaryGet200ResponseSitesInnerDevicesInner struct for V1DevicesSummaryGet200ResponseSitesInnerDevicesInner
type V1DevicesSummaryGet200ResponseSitesInnerDevicesInner struct {
	Id *int64 `json:"id,omitempty"`
	IsVirtual *bool `json:"isVirtual,omitempty"`
	Name *string `json:"name,omitempty"`
	OverrideRegion *V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerRegion `json:"overrideRegion,omitempty"`
...
func NewV1DevicesSummaryGet200ResponseSitesInnerDevicesInner() *V1DevicesSummaryGet200ResponseSitesInnerDevicesInner {
	this := V1DevicesSummaryGet200ResponseSitesInnerDevicesInner{}
	return &this
}
...
// SetOverrideRegion gets a reference to the given V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerRegion and assigns it to the OverrideRegion field.
...
func (o V1DevicesSummaryGet200ResponseSitesInnerDevicesInner) MarshalJSON() ([]byte, error) {
...
func (o V1DevicesSummaryGet200ResponseSitesInnerDevicesInner) ToMap() (map[string]interface{}, error) {
...
type NullableV1DevicesSummaryGet200ResponseSitesInnerDevicesInner struct {
	value *V1DevicesSummaryGet200ResponseSitesInnerDevicesInner
	isSet bool
}

func (v NullableV1DevicesSummaryGet200ResponseSitesInnerDevicesInner) Get() *V1DevicesSummaryGet200ResponseSitesInnerDevicesInner {
	return v.value
}

func (v *NullableV1DevicesSummaryGet200ResponseSitesInnerDevicesInner) Set(val *V1DevicesSummaryGet200ResponseSitesInnerDevicesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableV1DevicesSummaryGet200ResponseSitesInnerDevicesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableV1DevicesSummaryGet200ResponseSitesInnerDevicesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1DevicesSummaryGet200ResponseSitesInnerDevicesInner(val *V1DevicesSummaryGet200ResponseSitesInnerDevicesInner) *NullableV1DevicesSummaryGet200ResponseSitesInnerDevicesInner {
	return &NullableV1DevicesSummaryGet200ResponseSitesInnerDevicesInner{value: val, isSet: true}
}

func (v NullableV1DevicesSummaryGet200ResponseSitesInnerDevicesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1DevicesSummaryGet200ResponseSitesInnerDevicesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
