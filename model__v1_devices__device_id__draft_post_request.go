...
type V1DevicesDeviceIdDraftPostRequest struct {
	...
	Draft *V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInner `json:"draft,omitempty"`
}
...
// SetDraft gets a reference to the given V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInner and assigns it to the Draft field.
