...
// checks if the StatsmonV2NodeCircuitInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StatsmonV2NodeCircuitInfo{}

// StatsmonV2NodeCircuitInfo struct for StatsmonV2NodeCircuitInfo
type StatsmonV2NodeCircuitInfo struct {
...
func NewStatsmonV2NodeCircuitInfo() *StatsmonV2NodeCircuitInfo {
	this := StatsmonV2NodeCircuitInfo{}
	return &this
}
...
func (o StatsmonV2NodeCircuitInfo) MarshalJSON() ([]byte, error) {
...
func (o StatsmonV2NodeCircuitInfo) ToMap() (map[string]interface{}, error) {
...
type NullableStatsmonV2NodeCircuitInfo struct {
	value *StatsmonV2NodeCircuitInfo
	isSet bool
}

func (v NullableStatsmonV2NodeCircuitInfo) Get() *StatsmonV2NodeCircuitInfo {
	return v.value
}

func (v *NullableStatsmonV2NodeCircuitInfo) Set(val *StatsmonV2NodeCircuitInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableStatsmonV2NodeCircuitInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableStatsmonV2NodeCircuitInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStatsmonV2NodeCircuitInfo(val *StatsmonV2NodeCircuitInfo) *NullableStatsmonV2NodeCircuitInfo {
	return &NullableStatsmonV2NodeCircuitInfo{value: val, isSet: true}
}

func (v NullableStatsmonV2NodeCircuitInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStatsmonV2NodeCircuitInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
