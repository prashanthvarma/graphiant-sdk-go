...
type V1ExtranetsSourceSegmentsPostRequest struct {
	...
	Target *ManaV2PolicyTargetInput `json:"target,omitempty"`
}
...
// SetTarget gets a reference to the given ManaV2PolicyTargetInput and assigns it to the Target field.
