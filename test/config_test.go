...
func ConfigureWan(deviceId int64, interfaceName string, wanCircuit string) {
	...
	circuit := map[string]graphiant_sdk.V1DevicesDeviceIdConfigPutRequestEdgeCircuitsValue{
		wanCircuit: {
	...
	configReq.Edge = graphiant_sdk.NewV1DevicesDeviceIdConfigPutRequestEdge()
	...
	interfaces := map[string]graphiant_sdk.V1DevicesDeviceIdConfigPutRequestEdgeInterfacesValue{
		interfaceName: {
			Interface: &graphiant_sdk.V1DevicesDeviceIdConfigPutRequestEdgeInterfacesValueInterface{
				...
				AdminStatus: graphiant_sdk.PtrBool(true),
				Ipv4: &graphiant_sdk.V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceGwGw{
					Address: &graphiant_sdk.V1GlobalConfigPatchRequestSnmpsValueConfigEngineEndpointsValueEngineEndpointAddressesValue{
...
func ConfigureSubInterface(deviceId int64, interfaceName string, lan string, vlan int32, ipv4Address string, ipv6Address string) {
	...
	interfaces := map[string]graphiant_sdk.V1DevicesDeviceIdConfigPutRequestEdgeInterfacesValue{
		interfaceName: {
			Interface: &graphiant_sdk.V1DevicesDeviceIdConfigPutRequestEdgeInterfacesValueInterface{
				Subinterfaces: &map[string]graphiant_sdk.V1DevicesDeviceIdConfigPutRequestEdgeInterfacesValueInterfaceSubinterfacesValue{
					fmt.Sprintf("%d", vlan): {
						Interface: &graphiant_sdk.V1DevicesDeviceIdConfigPutRequestEdgeInterfacesValueInterfaceSubinterfacesValueInterface{
							AdminStatus: graphiant_sdk.PtrBool(true),
							Ipv4: &graphiant_sdk.V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceGwGw{
								Address: &graphiant_sdk.V1GlobalConfigPatchRequestSnmpsValueConfigEngineEndpointsValueEngineEndpointAddressesValue{
									Address: graphiant_sdk.PtrString(ipv4Address),
...
func Test_configure_wan_interface(t *testing.T) {
	...
	ConfigureWan(30000048295, "GigabitEthernet7/0/0", "c-gigabitethernet7-0-0")
}
...
func Test_configure_lan_interface(t *testing.T) {
	...
	ConfigureLan(30000048295, "GigabitEthernet7/0/0", "lan-7-test", "10.2.7.2/24", "2001:10:2:7::2/64")
}
...
func Test_deconfigure_lan_interface(t *testing.T) {
	...
	ConfigureDefaultLan(30000048295, "GigabitEthernet7/0/0", "default-10000000335")
}
...
func Test_configure_sub_interface(t *testing.T) {
	...
	ConfigureSubInterface(30000048295, "GigabitEthernet7/0/0", "lan-7-test", 28, "10.2.7.2/24", "2001:10:2:7::2/64")
}
...
func Test_delete_sub_interface(t *testing.T) {
	...
	DeleteSubInterface(30000048295, "GigabitEthernet7/0/0", 28)
}
