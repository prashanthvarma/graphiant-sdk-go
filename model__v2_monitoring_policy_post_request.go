...
type V2MonitoringPolicyPostRequest struct {
	...
	Selectors []V2MonitoringPolicyPostRequestSelectorsInner `json:"selectors,omitempty"`
...
// SetSelectors gets a reference to the given []V2MonitoringPolicyPostRequestSelectorsInner and assigns it to the Selectors field.
