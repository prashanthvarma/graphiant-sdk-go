...
// checks if the V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner{}

// V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner struct for V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner
type V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner struct {
	...
	ChildrenAlertList *V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInnerChildrenAlertList `json:"childrenAlertList,omitempty"`
...
// NewV2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner instantiates a new V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewV2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner() *V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner {
	this := V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner{}
	return &this
}
...
func (o *V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner) GetAlertId() string {
...
func (o *V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner) GetChildrenAlertList() V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInnerChildrenAlertList {
	if o == nil || IsNil(o.ChildrenAlertList) {
		var ret V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInnerChildrenAlertList
		return ret
	}
...
// SetChildrenAlertList gets a reference to the given V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInnerChildrenAlertList and assigns it to the ChildrenAlertList field.
...
func (o *V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner) HasDescendantPresent() bool {
	if o != nil && !IsNil(o.DescendantPresent) {
		return true
	}
...
func (o *V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner) HasEndTime() bool {
	if o != nil && !IsNil(o.EndTime) {
		return true
	}
...
func (o *V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner) HasEntity() bool {
	if o != nil && !IsNil(o.Entity) {
		return true
	}
...
func (o *V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner) SetPeerInterfaceName(v string) {
...
func (o *V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner) SetPlane(v string) {
	o.Plane = &v
}
...
func (o V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner) MarshalJSON() ([]byte, error) {
...
func (o V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner) ToMap() (map[string]interface{}, error) {
...
type NullableV2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner struct {
	value *V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner
	isSet bool
}

func (v NullableV2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner) Get() *V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner {
	return v.value
}

func (v *NullableV2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner) Set(val *V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner) {
	v.value = val
	v.isSet = true
}

func (v NullableV2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner) IsSet() bool {
	return v.isSet
}

func (v *NullableV2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner(val *V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner) *NullableV2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner {
	return &NullableV2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner{value: val, isSet: true}
}

func (v NullableV2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
