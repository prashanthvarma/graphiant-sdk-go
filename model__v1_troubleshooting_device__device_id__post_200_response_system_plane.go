...
// checks if the V1TroubleshootingDeviceDeviceIdPost200ResponseSystemPlane type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1TroubleshootingDeviceDeviceIdPost200ResponseSystemPlane{}

// V1TroubleshootingDeviceDeviceIdPost200ResponseSystemPlane struct for V1TroubleshootingDeviceDeviceIdPost200ResponseSystemPlane
type V1TroubleshootingDeviceDeviceIdPost200ResponseSystemPlane struct {
	...
	Temperature []V2NotificationlistPostRequest `json:"temperature,omitempty"`
...
func NewV1TroubleshootingDeviceDeviceIdPost200ResponseSystemPlane() *V1TroubleshootingDeviceDeviceIdPost200ResponseSystemPlane {
	this := V1TroubleshootingDeviceDeviceIdPost200ResponseSystemPlane{}
	return &this
}
...
// SetTemperature gets a reference to the given []V2NotificationlistPostRequest and assigns it to the Temperature field.
...
func (o *V1TroubleshootingDeviceDeviceIdPost200ResponseSystemPlane) GetTemperatureSeries() []V1BackboneHealthDeviceDeviceIdPost200ResponseControlPlaneControlTransitionsTransitionsInnerTransitionsInner {
...
func (o V1TroubleshootingDeviceDeviceIdPost200ResponseSystemPlane) MarshalJSON() ([]byte, error) {
...
func (o V1TroubleshootingDeviceDeviceIdPost200ResponseSystemPlane) ToMap() (map[string]interface{}, error) {
...
type NullableV1TroubleshootingDeviceDeviceIdPost200ResponseSystemPlane struct {
	value *V1TroubleshootingDeviceDeviceIdPost200ResponseSystemPlane
	isSet bool
}

func (v NullableV1TroubleshootingDeviceDeviceIdPost200ResponseSystemPlane) Get() *V1TroubleshootingDeviceDeviceIdPost200ResponseSystemPlane {
	return v.value
}

func (v *NullableV1TroubleshootingDeviceDeviceIdPost200ResponseSystemPlane) Set(val *V1TroubleshootingDeviceDeviceIdPost200ResponseSystemPlane) {
	v.value = val
	v.isSet = true
}

func (v NullableV1TroubleshootingDeviceDeviceIdPost200ResponseSystemPlane) IsSet() bool {
	return v.isSet
}

func (v *NullableV1TroubleshootingDeviceDeviceIdPost200ResponseSystemPlane) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1TroubleshootingDeviceDeviceIdPost200ResponseSystemPlane(val *V1TroubleshootingDeviceDeviceIdPost200ResponseSystemPlane) *NullableV1TroubleshootingDeviceDeviceIdPost200ResponseSystemPlane {
	return &NullableV1TroubleshootingDeviceDeviceIdPost200ResponseSystemPlane{value: val, isSet: true}
}

func (v NullableV1TroubleshootingDeviceDeviceIdPost200ResponseSystemPlane) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1TroubleshootingDeviceDeviceIdPost200ResponseSystemPlane) UnmarshalJSON(src []byte) error {
	v.isSet = true
