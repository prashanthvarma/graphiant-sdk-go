...
type V2AuditLogsPostRequest struct {
	...
	Selector *AuditmonAuditLogsV2Selector `json:"selector,omitempty"`
}
...
func (o *V2AuditLogsPostRequest) GetSelector() AuditmonAuditLogsV2Selector {
	if o == nil || IsNil(o.Selector) {
		var ret AuditmonAuditLogsV2Selector
		return ret
	}
	return *o.Selector
}
...
// SetSelector gets a reference to the given AuditmonAuditLogsV2Selector and assigns it to the Selector field.
