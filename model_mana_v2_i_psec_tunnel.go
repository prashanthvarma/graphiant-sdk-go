...
// checks if the ManaV2IPsecTunnel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManaV2IPsecTunnel{}

// ManaV2IPsecTunnel struct for ManaV2IPsecTunnel
type ManaV2IPsecTunnel struct {
...
func (o ManaV2IPsecTunnel) MarshalJSON() ([]byte, error) {
...
func (o ManaV2IPsecTunnel) ToMap() (map[string]interface{}, error) {
...
type NullableManaV2IPsecTunnel struct {
	value *ManaV2IPsecTunnel
	isSet bool
}

func (v NullableManaV2IPsecTunnel) Get() *ManaV2IPsecTunnel {
	return v.value
}

func (v *NullableManaV2IPsecTunnel) Set(val *ManaV2IPsecTunnel) {
	v.value = val
	v.isSet = true
}

func (v NullableManaV2IPsecTunnel) IsSet() bool {
	return v.isSet
}

func (v *NullableManaV2IPsecTunnel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManaV2IPsecTunnel(val *ManaV2IPsecTunnel) *NullableManaV2IPsecTunnel {
	return &NullableManaV2IPsecTunnel{value: val, isSet: true}
}

func (v NullableManaV2IPsecTunnel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManaV2IPsecTunnel) UnmarshalJSON(src []byte) error {
	v.isSet = true
