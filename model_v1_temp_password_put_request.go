...
type _V1TempPasswordPutRequest V1TempPasswordPutRequest
...
func (o *V1TempPasswordPutRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varV1TempPasswordPutRequest := _V1TempPasswordPutRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV1TempPasswordPutRequest)

	if err != nil {
		return err
	}

	*o = V1TempPasswordPutRequest(varV1TempPasswordPutRequest)
