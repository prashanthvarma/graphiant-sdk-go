...
type V2MonitoringSystemGenericPostRequest struct {
	...
	Selectors []StatsmonV2GenericSystemStatsSelector `json:"selectors,omitempty"`
...
// SetSelectors gets a reference to the given []StatsmonV2GenericSystemStatsSelector and assigns it to the Selectors field.
