...
type V1PolicyPrefixSetsPostRequest struct {
	...
	Entries *map[string]V1PolicyPrefixSetsPostRequestEntriesValue `json:"entries,omitempty"`
	Mode *string `json:"mode,omitempty"`
	Name *string `json:"name,omitempty"`
	PrefixSetEntries *map[string]V1GlobalConfigPatchRequestGlobalPrefixSetsValuePrefixSetEntriesValueEntry `json:"prefixSetEntries,omitempty"`
}
...
func (o *V1PolicyPrefixSetsPostRequest) GetEntries() map[string]V1PolicyPrefixSetsPostRequestEntriesValue {
	if o == nil || IsNil(o.Entries) {
		var ret map[string]V1PolicyPrefixSetsPostRequestEntriesValue
		return ret
	}
	return *o.Entries
}
...
// SetEntries gets a reference to the given map[string]V1PolicyPrefixSetsPostRequestEntriesValue and assigns it to the Entries field.
...
// SetPrefixSetEntries gets a reference to the given map[string]V1GlobalConfigPatchRequestGlobalPrefixSetsValuePrefixSetEntriesValueEntry and assigns it to the PrefixSetEntries field.
