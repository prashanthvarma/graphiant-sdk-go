...
// checks if the V1PortalPrivateSyncPostRequestInventoryInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1PortalPrivateSyncPostRequestInventoryInner{}

// V1PortalPrivateSyncPostRequestInventoryInner struct for V1PortalPrivateSyncPostRequestInventoryInner
type V1PortalPrivateSyncPostRequestInventoryInner struct {
...
func NewV1PortalPrivateSyncPostRequestInventoryInner() *V1PortalPrivateSyncPostRequestInventoryInner {
	this := V1PortalPrivateSyncPostRequestInventoryInner{}
	return &this
}
...
func (o V1PortalPrivateSyncPostRequestInventoryInner) MarshalJSON() ([]byte, error) {
...
func (o V1PortalPrivateSyncPostRequestInventoryInner) ToMap() (map[string]interface{}, error) {
...
type NullableV1PortalPrivateSyncPostRequestInventoryInner struct {
	value *V1PortalPrivateSyncPostRequestInventoryInner
	isSet bool
}

func (v NullableV1PortalPrivateSyncPostRequestInventoryInner) Get() *V1PortalPrivateSyncPostRequestInventoryInner {
	return v.value
}

func (v *NullableV1PortalPrivateSyncPostRequestInventoryInner) Set(val *V1PortalPrivateSyncPostRequestInventoryInner) {
	v.value = val
	v.isSet = true
}

func (v NullableV1PortalPrivateSyncPostRequestInventoryInner) IsSet() bool {
	return v.isSet
}

func (v *NullableV1PortalPrivateSyncPostRequestInventoryInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1PortalPrivateSyncPostRequestInventoryInner(val *V1PortalPrivateSyncPostRequestInventoryInner) *NullableV1PortalPrivateSyncPostRequestInventoryInner {
	return &NullableV1PortalPrivateSyncPostRequestInventoryInner{value: val, isSet: true}
}

func (v NullableV1PortalPrivateSyncPostRequestInventoryInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1PortalPrivateSyncPostRequestInventoryInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
