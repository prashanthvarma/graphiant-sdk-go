...
type V1AuditLogsPostRequest struct {
	...
	Selectors []AuditmonSelector `json:"selectors,omitempty"`
}
...
// SetSelectors gets a reference to the given []AuditmonSelector and assigns it to the Selectors field.
