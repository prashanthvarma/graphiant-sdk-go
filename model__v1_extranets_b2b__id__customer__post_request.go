...
type V1ExtranetsB2bIdCustomerPostRequest struct {
	Invites []V1ExtranetsB2bIdCustomerPostRequestInvitesInner `json:"invites,omitempty"`
}
...
func (o *V1ExtranetsB2bIdCustomerPostRequest) GetInvites() []V1ExtranetsB2bIdCustomerPostRequestInvitesInner {
	if o == nil || IsNil(o.Invites) {
		var ret []V1ExtranetsB2bIdCustomerPostRequestInvitesInner
		return ret
	}
	return o.Invites
}
...
// SetInvites gets a reference to the given []V1ExtranetsB2bIdCustomerPostRequestInvitesInner and assigns it to the Invites field.
