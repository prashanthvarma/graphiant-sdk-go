...
type V2MonitoringInterfacePostRequest struct {
	...
	Selectors []StatsmonV2InterfaceStatsSelector `json:"selectors,omitempty"`
...
// SetSelectors gets a reference to the given []StatsmonV2InterfaceStatsSelector and assigns it to the Selectors field.
