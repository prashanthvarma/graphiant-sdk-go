...
// checks if the V2AssuranceTopologyClientSummariesPost200ResponseSummariesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2AssuranceTopologyClientSummariesPost200ResponseSummariesInner{}

// V2AssuranceTopologyClientSummariesPost200ResponseSummariesInner struct for V2AssuranceTopologyClientSummariesPost200ResponseSummariesInner
type V2AssuranceTopologyClientSummariesPost200ResponseSummariesInner struct {
...
func NewV2AssuranceTopologyClientSummariesPost200ResponseSummariesInner() *V2AssuranceTopologyClientSummariesPost200ResponseSummariesInner {
	this := V2AssuranceTopologyClientSummariesPost200ResponseSummariesInner{}
	return &this
}
...
func (o V2AssuranceTopologyClientSummariesPost200ResponseSummariesInner) MarshalJSON() ([]byte, error) {
...
func (o V2AssuranceTopologyClientSummariesPost200ResponseSummariesInner) ToMap() (map[string]interface{}, error) {
...
type NullableV2AssuranceTopologyClientSummariesPost200ResponseSummariesInner struct {
	value *V2AssuranceTopologyClientSummariesPost200ResponseSummariesInner
	isSet bool
}

func (v NullableV2AssuranceTopologyClientSummariesPost200ResponseSummariesInner) Get() *V2AssuranceTopologyClientSummariesPost200ResponseSummariesInner {
	return v.value
}

func (v *NullableV2AssuranceTopologyClientSummariesPost200ResponseSummariesInner) Set(val *V2AssuranceTopologyClientSummariesPost200ResponseSummariesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableV2AssuranceTopologyClientSummariesPost200ResponseSummariesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableV2AssuranceTopologyClientSummariesPost200ResponseSummariesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2AssuranceTopologyClientSummariesPost200ResponseSummariesInner(val *V2AssuranceTopologyClientSummariesPost200ResponseSummariesInner) *NullableV2AssuranceTopologyClientSummariesPost200ResponseSummariesInner {
	return &NullableV2AssuranceTopologyClientSummariesPost200ResponseSummariesInner{value: val, isSet: true}
}

func (v NullableV2AssuranceTopologyClientSummariesPost200ResponseSummariesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2AssuranceTopologyClientSummariesPost200ResponseSummariesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
