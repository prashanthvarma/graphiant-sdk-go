...
// checks if the V2MonitoringBfdPost200ResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2MonitoringBfdPost200ResponseDataInner{}

// V2MonitoringBfdPost200ResponseDataInner struct for V2MonitoringBfdPost200ResponseDataInner
type V2MonitoringBfdPost200ResponseDataInner struct {
	Samples []V2MonitoringBfdPost200ResponseDataInnerSamplesInner `json:"samples,omitempty"`
	Selector *V2MonitoringBfdPostRequestSelectorsInner `json:"selector,omitempty"`
}
...
func NewV2MonitoringBfdPost200ResponseDataInner() *V2MonitoringBfdPost200ResponseDataInner {
	this := V2MonitoringBfdPost200ResponseDataInner{}
	return &this
}
...
// SetSelector gets a reference to the given V2MonitoringBfdPostRequestSelectorsInner and assigns it to the Selector field.
func (o *V2MonitoringBfdPost200ResponseDataInner) SetSelector(v V2MonitoringBfdPostRequestSelectorsInner) {
	o.Selector = &v
}

func (o V2MonitoringBfdPost200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o V2MonitoringBfdPost200ResponseDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableV2MonitoringBfdPost200ResponseDataInner struct {
	value *V2MonitoringBfdPost200ResponseDataInner
	isSet bool
}

func (v NullableV2MonitoringBfdPost200ResponseDataInner) Get() *V2MonitoringBfdPost200ResponseDataInner {
	return v.value
}

func (v *NullableV2MonitoringBfdPost200ResponseDataInner) Set(val *V2MonitoringBfdPost200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableV2MonitoringBfdPost200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableV2MonitoringBfdPost200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2MonitoringBfdPost200ResponseDataInner(val *V2MonitoringBfdPost200ResponseDataInner) *NullableV2MonitoringBfdPost200ResponseDataInner {
	return &NullableV2MonitoringBfdPost200ResponseDataInner{value: val, isSet: true}
}

func (v NullableV2MonitoringBfdPost200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2MonitoringBfdPost200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
