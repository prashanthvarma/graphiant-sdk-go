...
// checks if the V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInner{}

// V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInner struct for V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInner
type V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInner struct {
	Id *int64 `json:"id,omitempty"`
	NextSet []V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInner `json:"nextSet,omitempty"`
...
func NewV1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInner() *V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInner {
	this := V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInner{}
	return &this
}
...
func (o *V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInner) GetNextSet() []V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInner {
	if o == nil || IsNil(o.NextSet) {
		var ret []V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInner
		return ret
	}
	return o.NextSet
}
...
// SetNextSet gets a reference to the given []V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInner and assigns it to the NextSet field.
...
func (o V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInner) MarshalJSON() ([]byte, error) {
...
func (o V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInner) ToMap() (map[string]interface{}, error) {
...
type NullableV1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInner struct {
	value *V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInner
	isSet bool
}

func (v NullableV1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInner) Get() *V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInner {
	return v.value
}

func (v *NullableV1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInner) Set(val *V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInner) {
	v.value = val
	v.isSet = true
}

func (v NullableV1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInner) IsSet() bool {
	return v.isSet
}

func (v *NullableV1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInner(val *V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInner) *NullableV1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInner {
	return &NullableV1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInner{value: val, isSet: true}
}

func (v NullableV1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
