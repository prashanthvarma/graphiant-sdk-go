...
// checks if the V1DeviceRoutingOspfv2AreaInterfaceGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1DeviceRoutingOspfv2AreaInterfaceGet200Response{}

// V1DeviceRoutingOspfv2AreaInterfaceGet200Response struct for V1DeviceRoutingOspfv2AreaInterfaceGet200Response
type V1DeviceRoutingOspfv2AreaInterfaceGet200Response struct {
	Interfaces []V1DeviceRoutingOspfv2AreaInterfaceGet200ResponseInterfacesInner `json:"interfaces,omitempty"`
...
func NewV1DeviceRoutingOspfv2AreaInterfaceGet200Response() *V1DeviceRoutingOspfv2AreaInterfaceGet200Response {
	this := V1DeviceRoutingOspfv2AreaInterfaceGet200Response{}
	return &this
}
...
func (o *V1DeviceRoutingOspfv2AreaInterfaceGet200Response) GetInterfaces() []V1DeviceRoutingOspfv2AreaInterfaceGet200ResponseInterfacesInner {
	if o == nil || IsNil(o.Interfaces) {
		var ret []V1DeviceRoutingOspfv2AreaInterfaceGet200ResponseInterfacesInner
		return ret
	}
	return o.Interfaces
}
...
// SetInterfaces gets a reference to the given []V1DeviceRoutingOspfv2AreaInterfaceGet200ResponseInterfacesInner and assigns it to the Interfaces field.
...
func (o V1DeviceRoutingOspfv2AreaInterfaceGet200Response) MarshalJSON() ([]byte, error) {
...
func (o V1DeviceRoutingOspfv2AreaInterfaceGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableV1DeviceRoutingOspfv2AreaInterfaceGet200Response struct {
	value *V1DeviceRoutingOspfv2AreaInterfaceGet200Response
	isSet bool
}

func (v NullableV1DeviceRoutingOspfv2AreaInterfaceGet200Response) Get() *V1DeviceRoutingOspfv2AreaInterfaceGet200Response {
	return v.value
}

func (v *NullableV1DeviceRoutingOspfv2AreaInterfaceGet200Response) Set(val *V1DeviceRoutingOspfv2AreaInterfaceGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableV1DeviceRoutingOspfv2AreaInterfaceGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableV1DeviceRoutingOspfv2AreaInterfaceGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1DeviceRoutingOspfv2AreaInterfaceGet200Response(val *V1DeviceRoutingOspfv2AreaInterfaceGet200Response) *NullableV1DeviceRoutingOspfv2AreaInterfaceGet200Response {
	return &NullableV1DeviceRoutingOspfv2AreaInterfaceGet200Response{value: val, isSet: true}
}

func (v NullableV1DeviceRoutingOspfv2AreaInterfaceGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1DeviceRoutingOspfv2AreaInterfaceGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
