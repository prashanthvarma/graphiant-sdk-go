...
// checks if the ManaV2RegionalAllocation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManaV2RegionalAllocation{}

// ManaV2RegionalAllocation struct for ManaV2RegionalAllocation
type ManaV2RegionalAllocation struct {
	// Gigabytes per second allowed for core network connections on this region
	AllocationCore *float32 `json:"allocationCore,omitempty"`
	// Gigabytes per second allowed for gateway connections on this region
	AllocationGw *float32 `json:"allocationGw,omitempty"`
	// Gigabytes per second allowed for dia gateway internet access on this region. Must be 0, 10, or 100
...
func (o ManaV2RegionalAllocation) MarshalJSON() ([]byte, error) {
...
func (o ManaV2RegionalAllocation) ToMap() (map[string]interface{}, error) {
...
type NullableManaV2RegionalAllocation struct {
	value *ManaV2RegionalAllocation
	isSet bool
}

func (v NullableManaV2RegionalAllocation) Get() *ManaV2RegionalAllocation {
	return v.value
}

func (v *NullableManaV2RegionalAllocation) Set(val *ManaV2RegionalAllocation) {
	v.value = val
	v.isSet = true
}

func (v NullableManaV2RegionalAllocation) IsSet() bool {
	return v.isSet
}

func (v *NullableManaV2RegionalAllocation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManaV2RegionalAllocation(val *ManaV2RegionalAllocation) *NullableManaV2RegionalAllocation {
	return &NullableManaV2RegionalAllocation{value: val, isSet: true}
}

func (v NullableManaV2RegionalAllocation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManaV2RegionalAllocation) UnmarshalJSON(src []byte) error {
	v.isSet = true
