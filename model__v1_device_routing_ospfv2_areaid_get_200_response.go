...
// checks if the V1DeviceRoutingOspfv2AreaidGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1DeviceRoutingOspfv2AreaidGet200Response{}

// V1DeviceRoutingOspfv2AreaidGet200Response struct for V1DeviceRoutingOspfv2AreaidGet200Response
type V1DeviceRoutingOspfv2AreaidGet200Response struct {
...
func NewV1DeviceRoutingOspfv2AreaidGet200Response() *V1DeviceRoutingOspfv2AreaidGet200Response {
	this := V1DeviceRoutingOspfv2AreaidGet200Response{}
	return &this
}
...
func (o V1DeviceRoutingOspfv2AreaidGet200Response) MarshalJSON() ([]byte, error) {
...
func (o V1DeviceRoutingOspfv2AreaidGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableV1DeviceRoutingOspfv2AreaidGet200Response struct {
	value *V1DeviceRoutingOspfv2AreaidGet200Response
	isSet bool
}

func (v NullableV1DeviceRoutingOspfv2AreaidGet200Response) Get() *V1DeviceRoutingOspfv2AreaidGet200Response {
	return v.value
}

func (v *NullableV1DeviceRoutingOspfv2AreaidGet200Response) Set(val *V1DeviceRoutingOspfv2AreaidGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableV1DeviceRoutingOspfv2AreaidGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableV1DeviceRoutingOspfv2AreaidGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1DeviceRoutingOspfv2AreaidGet200Response(val *V1DeviceRoutingOspfv2AreaidGet200Response) *NullableV1DeviceRoutingOspfv2AreaidGet200Response {
	return &NullableV1DeviceRoutingOspfv2AreaidGet200Response{value: val, isSet: true}
}

func (v NullableV1DeviceRoutingOspfv2AreaidGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1DeviceRoutingOspfv2AreaidGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
