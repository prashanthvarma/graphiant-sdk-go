...
type V1GatewaysStatusPostRequest struct {
	DeviceInfo []V1GatewaysStatusPostRequestDeviceInfo `json:"deviceInfo,omitempty"`
...
func (o *V1GatewaysStatusPostRequest) GetDeviceInfo() []V1GatewaysStatusPostRequestDeviceInfo {
	if o == nil || IsNil(o.DeviceInfo) {
		var ret []V1GatewaysStatusPostRequestDeviceInfo
		return ret
	}
	return o.DeviceInfo
}
...
// SetDeviceInfo gets a reference to the given []V1GatewaysStatusPostRequestDeviceInfo and assigns it to the DeviceInfo field.
