...
// checks if the V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner{}

// V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner struct for V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner
type V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner struct {
	Id *int64 `json:"id,omitempty"`
	NextSet []V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner `json:"nextSet,omitempty"`
...
func NewV1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner() *V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner {
	this := V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner{}
	return &this
}
...
func (o *V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner) GetNextSet() []V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner {
	if o == nil || IsNil(o.NextSet) {
		var ret []V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner
		return ret
	}
	return o.NextSet
}
...
// SetNextSet gets a reference to the given []V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner and assigns it to the NextSet field.
...
func (o V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner) MarshalJSON() ([]byte, error) {
...
func (o V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner) ToMap() (map[string]interface{}, error) {
...
type NullableV1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner struct {
	value *V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner
	isSet bool
}

func (v NullableV1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner) Get() *V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner {
	return v.value
}

func (v *NullableV1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner) Set(val *V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner) {
	v.value = val
	v.isSet = true
}

func (v NullableV1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner) IsSet() bool {
	return v.isSet
}

func (v *NullableV1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner(val *V1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner) *NullableV1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner {
	return &NullableV1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner{value: val, isSet: true}
}

func (v NullableV1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1PolicyRouteTagSetsTagsGet200ResponseTagsInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInnerNextSetInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
