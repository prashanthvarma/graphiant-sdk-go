...
type V1FlowsTopologyPostRequest struct {
	AppSelector *IpfixAppTopologySelector `json:"appSelector,omitempty"`
...
func (o *V1FlowsTopologyPostRequest) GetAppSelector() IpfixAppTopologySelector {
	if o == nil || IsNil(o.AppSelector) {
		var ret IpfixAppTopologySelector
		return ret
	}
...
// SetAppSelector gets a reference to the given IpfixAppTopologySelector and assigns it to the AppSelector field.
