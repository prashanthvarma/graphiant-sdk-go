...
// checks if the V1BwtrackerRegionSiteSummaryPost200ResponseBwusageSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1BwtrackerRegionSiteSummaryPost200ResponseBwusageSummary{}

// V1BwtrackerRegionSiteSummaryPost200ResponseBwusageSummary struct for V1BwtrackerRegionSiteSummaryPost200ResponseBwusageSummary
type V1BwtrackerRegionSiteSummaryPost200ResponseBwusageSummary struct {
...
func NewV1BwtrackerRegionSiteSummaryPost200ResponseBwusageSummary() *V1BwtrackerRegionSiteSummaryPost200ResponseBwusageSummary {
	this := V1BwtrackerRegionSiteSummaryPost200ResponseBwusageSummary{}
	return &this
}
...
func (o V1BwtrackerRegionSiteSummaryPost200ResponseBwusageSummary) MarshalJSON() ([]byte, error) {
...
func (o V1BwtrackerRegionSiteSummaryPost200ResponseBwusageSummary) ToMap() (map[string]interface{}, error) {
...
type NullableV1BwtrackerRegionSiteSummaryPost200ResponseBwusageSummary struct {
	value *V1BwtrackerRegionSiteSummaryPost200ResponseBwusageSummary
	isSet bool
}

func (v NullableV1BwtrackerRegionSiteSummaryPost200ResponseBwusageSummary) Get() *V1BwtrackerRegionSiteSummaryPost200ResponseBwusageSummary {
	return v.value
}

func (v *NullableV1BwtrackerRegionSiteSummaryPost200ResponseBwusageSummary) Set(val *V1BwtrackerRegionSiteSummaryPost200ResponseBwusageSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableV1BwtrackerRegionSiteSummaryPost200ResponseBwusageSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableV1BwtrackerRegionSiteSummaryPost200ResponseBwusageSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1BwtrackerRegionSiteSummaryPost200ResponseBwusageSummary(val *V1BwtrackerRegionSiteSummaryPost200ResponseBwusageSummary) *NullableV1BwtrackerRegionSiteSummaryPost200ResponseBwusageSummary {
	return &NullableV1BwtrackerRegionSiteSummaryPost200ResponseBwusageSummary{value: val, isSet: true}
}

func (v NullableV1BwtrackerRegionSiteSummaryPost200ResponseBwusageSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1BwtrackerRegionSiteSummaryPost200ResponseBwusageSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
