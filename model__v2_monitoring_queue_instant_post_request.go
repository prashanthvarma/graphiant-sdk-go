...
type V2MonitoringQueueInstantPostRequest struct {
	...
	Selectors []V2MonitoringQueueInstantPostRequestSelectorsInner `json:"selectors,omitempty"`
...
func (o *V2MonitoringQueueInstantPostRequest) GetSelectors() []V2MonitoringQueueInstantPostRequestSelectorsInner {
	if o == nil || IsNil(o.Selectors) {
		var ret []V2MonitoringQueueInstantPostRequestSelectorsInner
		return ret
	}
	return o.Selectors
}
...
// SetSelectors gets a reference to the given []V2MonitoringQueueInstantPostRequestSelectorsInner and assigns it to the Selectors field.
