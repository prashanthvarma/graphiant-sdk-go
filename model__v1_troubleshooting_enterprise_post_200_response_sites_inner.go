...
// checks if the V1TroubleshootingEnterprisePost200ResponseSitesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1TroubleshootingEnterprisePost200ResponseSitesInner{}

// V1TroubleshootingEnterprisePost200ResponseSitesInner struct for V1TroubleshootingEnterprisePost200ResponseSitesInner
type V1TroubleshootingEnterprisePost200ResponseSitesInner struct {
...
func NewV1TroubleshootingEnterprisePost200ResponseSitesInner() *V1TroubleshootingEnterprisePost200ResponseSitesInner {
	this := V1TroubleshootingEnterprisePost200ResponseSitesInner{}
	return &this
}
...
func (o *V1TroubleshootingEnterprisePost200ResponseSitesInner) SetOverallStatus(v string) {
	o.OverallStatus = &v
}
...
func (o V1TroubleshootingEnterprisePost200ResponseSitesInner) MarshalJSON() ([]byte, error) {
...
func (o V1TroubleshootingEnterprisePost200ResponseSitesInner) ToMap() (map[string]interface{}, error) {
...
type NullableV1TroubleshootingEnterprisePost200ResponseSitesInner struct {
	value *V1TroubleshootingEnterprisePost200ResponseSitesInner
	isSet bool
}

func (v NullableV1TroubleshootingEnterprisePost200ResponseSitesInner) Get() *V1TroubleshootingEnterprisePost200ResponseSitesInner {
	return v.value
}

func (v *NullableV1TroubleshootingEnterprisePost200ResponseSitesInner) Set(val *V1TroubleshootingEnterprisePost200ResponseSitesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableV1TroubleshootingEnterprisePost200ResponseSitesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableV1TroubleshootingEnterprisePost200ResponseSitesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1TroubleshootingEnterprisePost200ResponseSitesInner(val *V1TroubleshootingEnterprisePost200ResponseSitesInner) *NullableV1TroubleshootingEnterprisePost200ResponseSitesInner {
	return &NullableV1TroubleshootingEnterprisePost200ResponseSitesInner{value: val, isSet: true}
}

func (v NullableV1TroubleshootingEnterprisePost200ResponseSitesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1TroubleshootingEnterprisePost200ResponseSitesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
