...
// checks if the V1ExtranetsB2bPeeringMatchServiceToCustomerPutRequestService type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1ExtranetsB2bPeeringMatchServiceToCustomerPutRequestService{}

// V1ExtranetsB2bPeeringMatchServiceToCustomerPutRequestService struct for V1ExtranetsB2bPeeringMatchServiceToCustomerPutRequestService
type V1ExtranetsB2bPeeringMatchServiceToCustomerPutRequestService struct {
...
func NewV1ExtranetsB2bPeeringMatchServiceToCustomerPutRequestService() *V1ExtranetsB2bPeeringMatchServiceToCustomerPutRequestService {
	this := V1ExtranetsB2bPeeringMatchServiceToCustomerPutRequestService{}
	return &this
}
...
func (o V1ExtranetsB2bPeeringMatchServiceToCustomerPutRequestService) MarshalJSON() ([]byte, error) {
...
func (o V1ExtranetsB2bPeeringMatchServiceToCustomerPutRequestService) ToMap() (map[string]interface{}, error) {
...
type NullableV1ExtranetsB2bPeeringMatchServiceToCustomerPutRequestService struct {
	value *V1ExtranetsB2bPeeringMatchServiceToCustomerPutRequestService
	isSet bool
}

func (v NullableV1ExtranetsB2bPeeringMatchServiceToCustomerPutRequestService) Get() *V1ExtranetsB2bPeeringMatchServiceToCustomerPutRequestService {
	return v.value
}

func (v *NullableV1ExtranetsB2bPeeringMatchServiceToCustomerPutRequestService) Set(val *V1ExtranetsB2bPeeringMatchServiceToCustomerPutRequestService) {
	v.value = val
	v.isSet = true
}

func (v NullableV1ExtranetsB2bPeeringMatchServiceToCustomerPutRequestService) IsSet() bool {
	return v.isSet
}

func (v *NullableV1ExtranetsB2bPeeringMatchServiceToCustomerPutRequestService) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1ExtranetsB2bPeeringMatchServiceToCustomerPutRequestService(val *V1ExtranetsB2bPeeringMatchServiceToCustomerPutRequestService) *NullableV1ExtranetsB2bPeeringMatchServiceToCustomerPutRequestService {
	return &NullableV1ExtranetsB2bPeeringMatchServiceToCustomerPutRequestService{value: val, isSet: true}
}

func (v NullableV1ExtranetsB2bPeeringMatchServiceToCustomerPutRequestService) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1ExtranetsB2bPeeringMatchServiceToCustomerPutRequestService) UnmarshalJSON(src []byte) error {
	v.isSet = true
