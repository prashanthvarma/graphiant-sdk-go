...
type V2MonitoringCircuitsUtilizationPostRequest struct {
	...
	Selectors []StatsmonV2CircuitUtilizationSelector `json:"selectors,omitempty"`
...
// SetSelectors gets a reference to the given []StatsmonV2CircuitUtilizationSelector and assigns it to the Selectors field.
