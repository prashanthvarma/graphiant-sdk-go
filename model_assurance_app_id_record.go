...
// checks if the AssuranceAppIdRecord type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssuranceAppIdRecord{}

// AssuranceAppIdRecord struct for AssuranceAppIdRecord
type AssuranceAppIdRecord struct {
...
func (o AssuranceAppIdRecord) MarshalJSON() ([]byte, error) {
...
func (o AssuranceAppIdRecord) ToMap() (map[string]interface{}, error) {
...
type NullableAssuranceAppIdRecord struct {
	value *AssuranceAppIdRecord
	isSet bool
}

func (v NullableAssuranceAppIdRecord) Get() *AssuranceAppIdRecord {
	return v.value
}

func (v *NullableAssuranceAppIdRecord) Set(val *AssuranceAppIdRecord) {
	v.value = val
	v.isSet = true
}

func (v NullableAssuranceAppIdRecord) IsSet() bool {
	return v.isSet
}

func (v *NullableAssuranceAppIdRecord) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAssuranceAppIdRecord(val *AssuranceAppIdRecord) *NullableAssuranceAppIdRecord {
	return &NullableAssuranceAppIdRecord{value: val, isSet: true}
}

func (v NullableAssuranceAppIdRecord) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAssuranceAppIdRecord) UnmarshalJSON(src []byte) error {
	v.isSet = true
