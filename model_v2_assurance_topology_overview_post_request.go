...
type V2AssuranceTopologyOverviewPostRequest struct {
	...
	Filter *V2AssuranceTopologyOverviewPostRequestTopologyFilter `json:"filter,omitempty"`
	FlexAlgoId *int64 `json:"flexAlgoId,omitempty"`
	SliderTimeWindow *AssuranceTimeWindow `json:"sliderTimeWindow,omitempty"`
	TimeWindow *AssuranceTimeWindow `json:"timeWindow,omitempty"`
	TopologyTs *GoogleProtobufTimestamp `json:"topologyTs,omitempty"`
...
func (o *V2AssuranceTopologyOverviewPostRequest) GetFilter() V2AssuranceTopologyOverviewPostRequestTopologyFilter {
	if o == nil || IsNil(o.Filter) {
		var ret V2AssuranceTopologyOverviewPostRequestTopologyFilter
		return ret
	}
	return *o.Filter
}
...
// SetFilter gets a reference to the given V2AssuranceTopologyOverviewPostRequestTopologyFilter and assigns it to the Filter field.
...
// SetSliderTimeWindow gets a reference to the given AssuranceTimeWindow and assigns it to the SliderTimeWindow field.
...
// SetTopologyTs gets a reference to the given GoogleProtobufTimestamp and assigns it to the TopologyTs field.
