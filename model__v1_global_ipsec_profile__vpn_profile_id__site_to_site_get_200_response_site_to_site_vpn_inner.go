...
// checks if the V1GlobalIpsecProfileVpnProfileIdSiteToSiteGet200ResponseSiteToSiteVpnInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1GlobalIpsecProfileVpnProfileIdSiteToSiteGet200ResponseSiteToSiteVpnInner{}

// V1GlobalIpsecProfileVpnProfileIdSiteToSiteGet200ResponseSiteToSiteVpnInner struct for V1GlobalIpsecProfileVpnProfileIdSiteToSiteGet200ResponseSiteToSiteVpnInner
type V1GlobalIpsecProfileVpnProfileIdSiteToSiteGet200ResponseSiteToSiteVpnInner struct {
...
func NewV1GlobalIpsecProfileVpnProfileIdSiteToSiteGet200ResponseSiteToSiteVpnInner() *V1GlobalIpsecProfileVpnProfileIdSiteToSiteGet200ResponseSiteToSiteVpnInner {
	this := V1GlobalIpsecProfileVpnProfileIdSiteToSiteGet200ResponseSiteToSiteVpnInner{}
	return &this
}
...
func (o V1GlobalIpsecProfileVpnProfileIdSiteToSiteGet200ResponseSiteToSiteVpnInner) MarshalJSON() ([]byte, error) {
...
func (o V1GlobalIpsecProfileVpnProfileIdSiteToSiteGet200ResponseSiteToSiteVpnInner) ToMap() (map[string]interface{}, error) {
...
type NullableV1GlobalIpsecProfileVpnProfileIdSiteToSiteGet200ResponseSiteToSiteVpnInner struct {
	value *V1GlobalIpsecProfileVpnProfileIdSiteToSiteGet200ResponseSiteToSiteVpnInner
	isSet bool
}

func (v NullableV1GlobalIpsecProfileVpnProfileIdSiteToSiteGet200ResponseSiteToSiteVpnInner) Get() *V1GlobalIpsecProfileVpnProfileIdSiteToSiteGet200ResponseSiteToSiteVpnInner {
	return v.value
}

func (v *NullableV1GlobalIpsecProfileVpnProfileIdSiteToSiteGet200ResponseSiteToSiteVpnInner) Set(val *V1GlobalIpsecProfileVpnProfileIdSiteToSiteGet200ResponseSiteToSiteVpnInner) {
	v.value = val
	v.isSet = true
}

func (v NullableV1GlobalIpsecProfileVpnProfileIdSiteToSiteGet200ResponseSiteToSiteVpnInner) IsSet() bool {
	return v.isSet
}

func (v *NullableV1GlobalIpsecProfileVpnProfileIdSiteToSiteGet200ResponseSiteToSiteVpnInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1GlobalIpsecProfileVpnProfileIdSiteToSiteGet200ResponseSiteToSiteVpnInner(val *V1GlobalIpsecProfileVpnProfileIdSiteToSiteGet200ResponseSiteToSiteVpnInner) *NullableV1GlobalIpsecProfileVpnProfileIdSiteToSiteGet200ResponseSiteToSiteVpnInner {
	return &NullableV1GlobalIpsecProfileVpnProfileIdSiteToSiteGet200ResponseSiteToSiteVpnInner{value: val, isSet: true}
}

func (v NullableV1GlobalIpsecProfileVpnProfileIdSiteToSiteGet200ResponseSiteToSiteVpnInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1GlobalIpsecProfileVpnProfileIdSiteToSiteGet200ResponseSiteToSiteVpnInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
