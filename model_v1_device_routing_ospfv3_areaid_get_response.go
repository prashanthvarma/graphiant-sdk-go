...
// checks if the V1DeviceRoutingOspfv3AreaidGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1DeviceRoutingOspfv3AreaidGetResponse{}

// V1DeviceRoutingOspfv3AreaidGetResponse struct for V1DeviceRoutingOspfv3AreaidGetResponse
type V1DeviceRoutingOspfv3AreaidGetResponse struct {
...
func NewV1DeviceRoutingOspfv3AreaidGetResponse() *V1DeviceRoutingOspfv3AreaidGetResponse {
	this := V1DeviceRoutingOspfv3AreaidGetResponse{}
	return &this
}
...
func (o V1DeviceRoutingOspfv3AreaidGetResponse) MarshalJSON() ([]byte, error) {
...
func (o V1DeviceRoutingOspfv3AreaidGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableV1DeviceRoutingOspfv3AreaidGetResponse struct {
	value *V1DeviceRoutingOspfv3AreaidGetResponse
	isSet bool
}

func (v NullableV1DeviceRoutingOspfv3AreaidGetResponse) Get() *V1DeviceRoutingOspfv3AreaidGetResponse {
	return v.value
}

func (v *NullableV1DeviceRoutingOspfv3AreaidGetResponse) Set(val *V1DeviceRoutingOspfv3AreaidGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableV1DeviceRoutingOspfv3AreaidGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableV1DeviceRoutingOspfv3AreaidGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1DeviceRoutingOspfv3AreaidGetResponse(val *V1DeviceRoutingOspfv3AreaidGetResponse) *NullableV1DeviceRoutingOspfv3AreaidGetResponse {
	return &NullableV1DeviceRoutingOspfv3AreaidGetResponse{value: val, isSet: true}
}

func (v NullableV1DeviceRoutingOspfv3AreaidGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1DeviceRoutingOspfv3AreaidGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
