...
type V1FlowsFlowTablePostRequest struct {
	// the app ID in the question from overall visuals view
	...
	// Number of app flow records requested by UI.
	NumFlowRecords *int32 `json:"numFlowRecords,omitempty"`
	Selector *IpfixAppFlowTableSelector `json:"selector,omitempty"`
...
func (o *V1FlowsFlowTablePostRequest) GetSelector() IpfixAppFlowTableSelector {
	if o == nil || IsNil(o.Selector) {
		var ret IpfixAppFlowTableSelector
		return ret
	}
	return *o.Selector
}
...
// SetSelector gets a reference to the given IpfixAppFlowTableSelector and assigns it to the Selector field.
